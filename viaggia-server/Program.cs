...
// Configure para aceitar raw body nos webhooks
...
.AddJwtBearer(options =>
{
    ...
    options.Events = new JwtBearerEvents
    {
        ...
        OnChallenge = context =>
        {
            Console.WriteLine($"⚠️ JWT Challenge: Error='{context.Error}', Description='{context.ErrorDescription}'");
            Console.WriteLine($"⚠️ Failure: {context.AuthenticateFailure?.Message}");
            return Task.CompletedTask;
        },
