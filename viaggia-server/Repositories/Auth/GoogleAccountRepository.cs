...
namespace viaggia_server.Repositories.Auth
{
    public class GoogleAccountRepository : IGoogleAccountRepository
    {
        ...
        private readonly ILogger<GoogleAccountRepository> _logger;

        public GoogleAccountRepository(AppDbContext context, IUserRepository userRepository, ILogger<GoogleAccountRepository> logger)
        {
